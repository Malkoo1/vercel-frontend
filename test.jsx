...
export const FolderProvider = ({ children }) => {
  ...
  const [files, setFiles] = useState(); // Files to display (can be filtered)
  ...
  const handleFolderSelect = async (folderId) => {
    ...
    try {
      ...
      setAllFiles(folderDetails.files); // Update all files
  ...
  const handleShareFolderSelect = async (folderId) => {
    ...
    try {
      ...
      setAllFiles(folderDetails.sharedFiles); // Update all shared files
      setFolders((prevFolders) =>
        prevFolders.map((folder) => ({
          ...folder,
          active: folder._id === folderId,
